...
Public Class MusteriSiparisGoster
    Public baglanti As New OleDbConnection("Provider=Microsoft.Jet.Oledb.4.0;Data Source=veritabani.mdb")
    Private Sub MusteriSiparisGoster_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        guncelle()
    ...
    Sub guncelle()
        ...
        baglanti.Open()
        Dim adtr As New OleDbDataAdapter("select * from siparis1 where islem like '" + beklemede.Text + "%' AND k_id like  '" + id.Text + "'", baglanti)
        adtr.Fill(tablo)
        DataGridView1.DataSource = tablo
        baglanti.Close()
    ...
    Private Sub DataGridView1_CellClick(sender As Object, e As DataGridViewCellEventArgs) Handles DataGridView1.CellClick
        ...
        If islem.Text = "Beklemede" Then
            islem.BackColor = Color.Yellow
            islem.ForeColor = Color.Black


        ElseIf islem.Text = "Hazır" Then
            islem.BackColor = Color.Green
            islem.ForeColor = Color.White
        ElseIf islem.Text = "İptal" Then
            islem.BackColor = Color.Red
            islem.ForeColor = Color.White
